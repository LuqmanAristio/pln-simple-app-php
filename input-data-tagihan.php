...
<div class="container">
	...
	<div class="right-bar">
		<form action="tambah-tagihan.php" method="POST">
			<div class="form">
				<h2>Input Data Tagihan</h2>
				...
				<div class="left">
					<div class="form-1">
						...
						<select name="KodeUser">
								...
								$sql = mysqli_query($konek,"SELECT * FROM tbuser where Level='Pelanggan' and KodeTarif>'0' ORDER BY KodeUser,NamaLengkap ASC");
								if(mysqli_num_rows($sql) != 0){
								while($row = mysqli_fetch_assoc($sql)){
									echo '<option value='.$row['KodeUser'].'>'.$row['NamaLengkap'].'</option>';
								}
									}
					...
					<div class="form-1">
						...
						<input type="number" name="Pemakaian" placeholder="Pemakaian" required>
					</div>
					<div class="submit">
